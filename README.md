...
![Obsidian](https://img.shields.io/github/manifest-json/testedWithObsidian/Dekimori/PersonalCapital-plugin?style=flat-square&color=7c3aed&label=tested%20with)
![Quality check](https://img.shields.io/github/actions/workflow/status/Dekimori/PersonalCapital-plugin/ci.yml?branch=main&style=flat-square&label=CI)
